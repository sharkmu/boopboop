...
- [ ] Add a timer
    ...
    - [ ] Have a "SKIP level" button to be able skip the level for a set amount of money * level number
...
- [x] Fix next level logic, there are some bugs with the text and stuff
